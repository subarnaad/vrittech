...
export const task1Data: FeatureCardType[] = [
        ...
        slides: [
            {
                ...
                imagePosition: "absolute -left-15 top-4 bottom-0 w-[240px] sm:w-[220px] md:w-[250px] lg:w-[350px]",
            ...
            },
            {
                ...
                contentPosition: "left-image",
                imagePosition: "absolute left-3 bottom-0 w-[240px] sm:w-[220px] md:w-[250px] lg:w-[300px]",
        ...
        slides: [
            {
                ...
                imagePosition: "absolute right-0 top-4 w-[240px] sm:w-[180px] md:w-[230px] lg:w-[280px]",
            ...
            },
            {
                ...
                contentPosition: "right-image",
                image: "c2p2.svg",
                imagePosition: "absolute right-0 top-14 buttom-0 w-[240px] sm:w-[180px] md:w-[230px] lg:w-[500px]",
            },
            {
                id: 3,
                ...
                contentPosition: "left-image",
                image: "c2p3.svg",
                imagePosition: "absolute  bottom-0 w-[240px] sm:w-[220px] md:w-[250px] lg:w-[500px]",
            },
        ]
    },
    {
        ...
        slides: [
            {
                ...
                imagePosition: "absolute -left-14 top-18 bottom-0 w-[240px] sm:w-[220px] md:w-[250px] lg:w-[400px]",
                contentPosition: "left-image",
            }
        ]
    },
    {
        ...
        slides: [{
            ...
            imagePosition: "absolute right-0 -bottom-23 w-[240px] sm:w-[250px] md:w-[250px] lg:w-[400px] ",
            contentPosition: "right-image",
        }]
